...
export const Header = () => {
  ...
  return (
    <header>
      <nav className="bg-white border-b-4 border-yellow-300 dark:bg-purple-500 dark:border-b-4 dark:border-green-800">
        <div className="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
            <Link to="/" className="flex items-center">
              <img src={Logo} className="h-8 mr-3" alt="Good Movies" />
              <span className="self-center text-2xl font-semibold whitespace-nowrap dark:text-white">Good Movies</span>
            </Link>
